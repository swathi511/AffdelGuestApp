...
import com.hjsoft.affdelguestapp.fragment.ParcelBookingFragment;
...
public class ParcelBookingActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerItem[0] = new NavigationData(R.drawable.arrow, "Parcel Booking");
        drawerItem[1] = new NavigationData(R.drawable.arrow, "All Bookings");
        drawerItem[2] = new NavigationData(R.drawable.arrow, "Cancel Booking");
    ...
    private void selectItem(int position) {
        ...
        switch (position) {
            ...
            case 0:
                Intent i=new Intent(ParcelBookingActivity.this,ParcelBookingActivity.class);
                startActivity(i);
                finish();
                break;
            case 1:
                Intent j=new Intent(ParcelBookingActivity.this,AllBookingsActivity.class);
                startActivity(j);
                finish();
                break;
            case 2:
                Intent k=new Intent(ParcelBookingActivity.this,CancelHistoryActivity.class);
                startActivity(k);
                finish();
                break;
            case 3:
                Intent l=new Intent(ParcelBookingActivity.this,ChangePasswordActivity.class);
                startActivity(l);
                finish();
                break;
