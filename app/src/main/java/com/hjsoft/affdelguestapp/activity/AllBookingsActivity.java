...
public class AllBookingsActivity extends AppCompatActivity implements RecyclerAdapter.AdapterCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment=new AllBookingsFragment();
    ...
    public void onMethodCallback(final int position, ArrayList<AllBookingsData> data) {
        ...
        args.putSerializable("list",data);
         ...
         Fragment frag = new SpecificBookingFragment();
