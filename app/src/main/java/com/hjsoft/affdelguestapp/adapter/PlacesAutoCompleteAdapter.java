...
public class PlacesAutoCompleteAdapter
    ...
    public PlacesAutoCompleteAdapter(Context context, int resource, GoogleApiClient googleApiClient,
        ...
        ArrayList<String> place=dbAdapter.getUserLocations();
        ...
        if(place.size()==0)
        {
            ...
            for(int i=0;i<place.size();i++) {
                mResultList.add(new PlaceAutocomplete(String.valueOf(i), place.get(i)));
            }
        }
    ...
    public class PredictionHolder extends RecyclerView.ViewHolder {
        ...
        public PredictionHolder(View itemView) {
            ...
            super(itemView);
            mPrediction = (TextView) itemView.findViewById(R.id.loc);
